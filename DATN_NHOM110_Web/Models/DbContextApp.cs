...
namespace Data.Models
{
    public class DbContextApp : DbContext
    {
...

        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=LAPTOP-UKQRGABP\SQLEXPRESS;Initial Catalog=DATN_NHOM110;User ID=sa;Password=123456;TrustServerCertificate=True"
);
